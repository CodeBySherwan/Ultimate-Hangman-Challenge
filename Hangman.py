...
def get_data_directory():
    ...
    if getattr(sys, 'frozen', False):
        ...
        app_data_dir = appdirs.user_data_dir(app_name, "CodeBySherwan")
...
=========''']
    ...
    def attempt_fullscreen(self):
        """
        Suggest the user enter fullscreen mode for a better experience.
        
        Attempts to use the keyboard library if available, otherwise prompts manually.
        """
        try:
            import keyboard
            keyboard.press('f11')
    ...
    def loading_screen(self):
        ...
        """
        print("\n" * 6)
        cprint(figlet_format('    CodeBy', font='starwars'), 'white', 'on_black', attrs=['blink'])
        cprint(figlet_format('Sherwan', font='slant'), 'light_green', 'on_black', attrs=['blink'])
        print()
        time.sleep(1.5)
        self.clear_screen()
